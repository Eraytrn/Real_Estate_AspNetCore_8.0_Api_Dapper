...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage14 = await client14.GetAsync("https://localhost:44353/api/Statistics/OldestBuildingYear");
            ...
            var responseMessage15 = await client15.GetAsync("https://localhost:44353/api/Statistics/PassiveCategoryCount");
